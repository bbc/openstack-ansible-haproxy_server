...
If a frontend service directs to multiple backend services using ACLs, and a backend
service does not require its own corresponding front-end, the `haproxy_backend_only`
...
.. code-block:: yaml
  ...
  - service:
        ...
        haproxy_backend_only: true          # Directed to by the 'influxdb-relay' service defined above
        haproxy_backend_nodes:
